...
// invoking start page
    ...
    By slectingZipCode = By.xpath("//input[@id='zipCode_overlay']");
    ...
    By bodyType = By.xpath("//select[@analytics-id='VehiclesNew_BodyStyle']");
    ...
    By maritualStatus = By.xpath("//select[@analytics-id='DriversAddPniDetails_MaritalStatus']");
    ...
    By moovedIn = By.xpath("//select[@analytics-id='DriversAddPniDetails_HasPriorAddress']");
    ...
    By ticketOrVoilation = By.xpath("//input[@analytics-id='DriversAddPniDetails_HasTicketsOrViolations_N']");
  ...
  //  By driverImprovement = By.xpath("//input[@analytics-id='DriversEditDriverAdditionalDetails_SafetyCourseTaken_N']");
    ...
    By haveAutoInsurence = By.xpath("//input[@analytics-id='FinalDetailsEdit_InsuranceToday_Y']");
    ...
    By finalButton = By.xpath("//loading-button[@id='nyp-blue-button']");
    ...
    public void setSlectingZipCode(String zipCode) {
        driver.findElement(slectingZipCode).sendKeys(zipCode);
    }
    ...
    public void setBodyType(String selectBody) {
        WebElement element = driver.findElement(bodyType);
        Select bodyType = new Select(element);
        bodyType.selectByValue("SUV (4CYL 4X2)");
    }
    ...
    public void setMaritualStatus(int index) {
        WebElement element = driver.findElement(maritualStatus);
    ...
    public void setMoovedIn(int index) {
        WebElement element = driver.findElement(moovedIn);
        Select select = new Select(element);
        select.selectByIndex(index);
    }
...
//    }
    ...
    public void setTicketOrVoilation() {
        driver.findElement(ticketOrVoilation).click();
    }
...
//    }
    ...
    public void setHaveAutoInsurence(){
        driver.findElement(haveAutoInsurence).click();
    }
